...
CREATE TABLE `Customers` (
  ...
  `buying_budget` int(11) DEFAULT NULL,
...
('Avery', 'Anderson', 2147483647, 'avery.anderson@zedfin.com'),
('Barney', 'Bird', 2147483647, 'barney.bird@zedfin.com'),
('Chris', 'Candy', 2147483647, 'chris.candy@zedfin.com'),
('Dan', 'Duncan', 2147483647, 'dan.duncan@zedfin.com'),
('Ethan', 'Esty', 2147483647, 'ethan.esty@zedfin.com');
...
('Molly', 'Mason', 2147483647, 'molly.mason@somemail.com', 1, 1000000, (SELECT agent_id FROM Agents WHERE agent_email = "barney.bird@zedfin.com")),
('Nelson', 'Nile', 2147483647, 'nelson.nile@somemail.com', 1, 1100000, (SELECT agent_id FROM Agents WHERE agent_email = "avery.anderson@zedfin.com")),
('Orla', 'Olson', 2147483647, 'orla.olson@somemail.com', 0, NULL, NULL),
('Patricia', 'Parson', 2147483647, 'patricia.parson@somemail.com', 0, NULL, NULL),
('Quentin', 'Quail', 2147483647, 'quentin.quail@somemail.com', 1, 900000, (SELECT agent_id FROM Agents WHERE agent_email = "ethan.esty@zedfin.com"));
